...
public class FrameView implements Runnable
{
	 ...
	 */
	public FrameView(final int minFloor, final int maxFloor, final int numLift, List<Elevator> elevators, JsonController json, InputView input)
	{
		this.minFloor = minFloor;
		this.maxFloor = maxFloor+1;
	...
	private void startGraphics()
	{
		...
		this.elevators = json.getElevatorArrayList();
		...
		jframe.add(new JComponent()
		{
			...
			public void paintComponent(Graphics graphics)
			{
				...
				{
					String liftLabelText = new String("");
					liftLabelText = elevators.get(i).getCommand();
